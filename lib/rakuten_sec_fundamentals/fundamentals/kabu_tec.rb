...
module KabuTec
  ...
  # 株価情報
  def stock_info
    stock_info_node_set = @kabutec_company_fs.search('//*[@id="cont_main"]/section[2]/div/table')
  ...
  def financial_statement
    fs_node_set = @kabutec_company_fs.search('//*[@id="cont_main"]/section[4]/div/div/table')
  ...
  def auto_trace_judgment
    judgment_node_set = @kabutec_company_fs.search('//*[@id="cont_main"]/section[3]/div/table')
    {
